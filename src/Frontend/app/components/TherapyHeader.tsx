...
export default function TherapyHeader({ therapyName, isEditing, handleNameClick, handleNameChange, handleNameBlur, isToggleOn, handleToggleClick } : { therapyName: string, isEditing: boolean, handleNameClick: () => void, handleNameChange: (e: React.ChangeEvent<HTMLInputElement>) => void, handleNameBlur: () => void, isToggleOn: boolean, handleToggleClick: () => void }) {
    return (
